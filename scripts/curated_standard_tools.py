...
T = [
    ...
    ("STITCH", "target-id", "Known and predicted chemical-protein interactions across species, useful for a first pass at what else a chemotype might touch.", "http://stitch.embl.de", None, "free-web", ["off-target", "chemical-protein"]),
