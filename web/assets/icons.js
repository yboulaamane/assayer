...
export const ICONS = {
  ...
  "omics": '<circle cx="8" cy="9" r="3"/><circle cx="16.5" cy="7.5" r="2.2"/><circle cx="14.5" cy="16" r="3.4"/><circle cx="6.5" cy="17" r="1.8"/>',
  "imaging": '<rect x="3" y="4.5" width="18" height="15" rx="2.4"/><circle cx="12" cy="12" r="3.6"/><path d="M6.6 8.1h.01"/>',
  ...
  "protein-ml": '<path d="M3 12h3.5M17.5 12H21"/><circle cx="9.5" cy="12" r="2.4"/><circle cx="14.5" cy="12" r="2.4"/><path d="M9.5 9.6V5.4M14.5 14.4v4.2"/>',
  "protein-design": '<path d="M12 3.2 19.4 7.4v9.2L12 20.8 4.6 16.6V7.4z"/><path d="m9.4 13.6 5-5M13.2 7.6l2.6 2.6"/>',
  "biologics": '<path d="M12 21v-7.2M12 13.8 6.4 6.2M12 13.8l5.6-7.6"/><path d="M4.4 3.6 6.4 6.2M19.6 3.6l-2 2.6"/>',
  "nucleic-acids": '<path d="M7.5 3c0 5 9 6 9 9s-9 4-9 9"/><path d="M16.5 3c0 5-9 6-9 9s9 4 9 9"/><path d="M8.8 6.4h6.4M8.8 17.6h6.4M7.6 12h8.8"/>',
  ...
  "generative": '<path d="M6.5 3.2 7.7 6l2.8 1.2-2.8 1.2-1.2 2.8-1.2-2.8L2.5 7.2 5.3 6z"/><circle cx="15.5" cy="14.5" r="2.4"/><circle cx="19.4" cy="8.2" r="1.8"/><path d="m14.2 12.4 3.8-2.8M13.4 16.6l-3.2 3.4"/>',
  ...
  "agents": '<rect x="3.2" y="6.4" width="17.6" height="11.4" rx="3"/><circle cx="9" cy="12" r="1.3"/><circle cx="15" cy="12" r="1.3"/><path d="M12 6.4V3.4M8.4 17.8 6.6 21M15.6 17.8 17.4 21"/>',
